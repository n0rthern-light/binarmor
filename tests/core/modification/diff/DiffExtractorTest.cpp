...
TEST(DiffExtractorTest, WillWorkCorrectlyWithHighEntrophy)
{
    auto original = byte_vec {'M', 'Z', 0x90, 0x00, 0x03, 0x00, 0x00, 0x00, 0x04, 0x00, 0x00, 0x00, 0xFF, 0xFF, 0x00, 0x00, 0xB8, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, '@', 0x00, 0x00, 0x00, 0x00, 0x00};
    auto target =   byte_vec {0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x80, 0x00, 0x00, 0x00, 0x0E, 0x1F, 0xBA, 0x0E, 0x00, 0xB4, 't', 0xCD, '!', 0xB8, 0x01, 'L', 0xCD, '!', 'T', 'h'};

    auto diffs = CDiffExtractor::extract(original, target);
