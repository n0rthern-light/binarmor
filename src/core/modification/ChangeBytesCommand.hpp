...
class CChangeBytesCommand : public IModificationCommand
{
    ...
    const BinaryModificationType m_modificationType;
...
public:
    CChangeBytesCommand(
        ...
        const BinaryModificationType modificationType,
    ...
    BinaryModificationType type() const { return m_modificationType; } 
